...
public class ElectronicsCollectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/app/ElectronicsCollection.jsp");
