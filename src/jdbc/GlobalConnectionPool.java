...
public class GlobalConnectionPool implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        System.out.println("here in the global connection ppol servlet context initialzied");
        ...
        try {
            System.out.println("trying to create the connection pool...");
            connectionPool.CreateConnectionPool(userid, password,
                    initialConnections, maxConnections, waitIfBusy);
            System.out.println("created the connection pool...");
